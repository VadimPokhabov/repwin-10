...
guides = [{
    ...
    "fields": {
        ...
        "tours_count": 5,
        "bio": "Я обожаю Москву, и изучаю город с необычных ракурсов. С радостью поделюсь с вами своими лучшими "
               "открытиями. Мы поднимемся на сталинские высотки и посмотрим на исторический центр сверху. Я покажу вам "
               "то, что скрыто от глаз большинства туристов и даже жителей города. Маршруты подобраны индивидуально под "
               "ваш запрос. Для влюбленных доступна услуга свидания на крыше.",
        "is_pro": True,
        "company": 1
    }
},
...
# for guid in guides:
#     g = guid["fields"]["tours_count"]
#     if g >= 5:
#         print(f'{guid["fields"]["full_name"]} | туров: {g}')
...
# for i in reviews:
#     pk.append(i["pk"])
#     stars.append(i["fields"]["stars"])
# print(f'Всего отзывов: {max(pk)} \nСредняя оценка: {sum(stars) / len(stars)}')
# print(pk)
# print(stars)
